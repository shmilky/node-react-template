...
export default class extends React.Component {
    closeModal () {
        ...
        const urlWithNoModal = routingHelpers.addQueryParam(pathname, search, {modal: null});

        this.props.history.push(urlWithNoModal);
    }

    render () {
        const queryParams = routingHelpers.parseQueryString(this.props.location.search);
